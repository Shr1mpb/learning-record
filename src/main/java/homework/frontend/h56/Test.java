...
public class Test {
	...
	public static void main(String[] args) {
		...
		String ip = "127.0.0.1";
		int port = 9090;
		String passwordFile = "D:\\JavaProjects\\Common\\src\\main\\java\\homework\\frontend\\h56\\user.txt";
		ChatServer server;
		try {
			...
			if (str1.equals(zhang.read()) && str1.equals(li.read()) && (null == wang.read())) {
				System.out.println("pass41");
			}

			zhang.logout();
			str1 = "I am li";
			li.speak(str1);
//			String zread = zhang.read();
//			System.out.println("zhang read: " + zread);
//			String lread = li.read();
//			System.out.println("li read: " + lread);
//			String wread = wang.read();
//			System.out.println("wang read: " + wread);
			// 4 zhang logout了
			if (str1.equals(li.read()) && (null == zhang.read()) && (null == wang.read())) {
				System.out.println("pass42");
			}
		} catch (Exception e) {
